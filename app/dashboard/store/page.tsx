  ...
  return (
    <div className="space-y-5" style={{ maxWidth: '1200px' }}>
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[22px] font-bold text-text-primary tracking-tight">스토어 설정</h1>
          <p className="text-sm text-text-secondary mt-1">서비스 상품을 관리합니다 · 신청 내역은 <a href="/dashboard/requests?type=order" className="text-primary hover:underline">신청관리</a>에서 확인</p>
        </div>
