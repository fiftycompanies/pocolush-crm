...
> 2026-05-16 16:00 kk 답변: "권고대로 진행"

- **Q1 (자동갱신 UX 적용)**: **A** (Phase 1 적용)
- **Q2 (Realtime 401 옵션)**: **옵션 1** (setAuth 즉시 호출)
- **Q3 (13 RPC 통일 마이그 083)**: **A** (Go)
- **Q4 (U2 활성화 시점)**: **(ii) 5/22 burn-in 경과 후** — 본 세션 스킵, 5/22 예약
- **Q5 (커밋 전략)**: **분리 4 PR**

✅ 승인 → PR1 (자동갱신) → PR2 (Realtime 401) → PR3 (13 RPC) 순차. PR4는 5/22 예약.
